...
export default class GameUi extends Scene {
    ...
    create() {
        ...
        // //coin
        // const panel = this.add.image(640, 0, "atlas", "panel.png").setOrigin(1, 0.5).setOffset(-50, 50);
        // const styleLabelPanel = { "color": "#000000", "fontFamily": "DimboRegular", "fontSize": "30px" };
        // const panelLabel = this.add.text(640, 0, "2403", styleLabelPanel).setOrigin(0.5, 0.5).setOffset(-135, 50);
        // const coin = this.add.image(640, 0, "atlas", "coin.png").setOrigin(0.5, 0.5).setOffset(-50, 50);

        // //button
        // const button = this.add.image(320, 1136, "atlas", "button.png").setOrigin(0.5, 0.5).setOffsetY(-100);
        // const styleLabelButton = { "color": "#ffffff", "fontFamily": "DimboRegular", "fontSize": "50px" };
        // const buttonLabel = this.add.text(320, 1136, "Start", styleLabelButton).setOrigin(0.5, 0.5).setOffsetY(-100);
